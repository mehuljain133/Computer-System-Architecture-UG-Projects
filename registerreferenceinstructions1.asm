...
; Assembly program to simulate Register Reference Instructions
; and determine the contents of AC, E, PC, AR, and IR registers

START:
    ; Initialize registers to arbitrary values
    LDA NUM1                 ; Load NUM1 into AC
    STA AC_REG               ; Store initial value in AC register (AC = NUM1)

    LDA NUM2                 ; Load NUM2 into AC (for operations)
    STA E_REG                ; Store NUM2 in E register (E = NUM2)
